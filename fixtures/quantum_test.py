...
class QuantumHelper(object):
    ...
    def create_subnet(self, subnet, net_id, ipam_fq_name=None, enable_dhcp=True, disable_gateway=False,dns_nameservers_list=None):
        subnet_req = subnet
...
#                         'connection_limit': connection_limit}
    ...
    def add_firewall_rule(self, policy_id, rule_id,
        ...
        self.obj.insert_rule_fwaas_firewall_policy(policy_id, body)
